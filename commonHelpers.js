...
</li>`).join("");m.innerHTML=t,y.refresh()}function L(o){const t="https://pixabay.com/api/",s="45176158-e3d3b26982233790558f60971",i=new URLSearchParams({key:s,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0});return fetch(`${t}?${i.toString()}`,{headers:{Accept:"application/json"}}).then(e=>{if(!e.ok)throw new Error(e.status);return e.json()})}const b={searchForm:document.querySelector(".search-form"),articlesContainer:document.querySelector(".articles"),loadMoreBtn:document.querySelector('[data-action="load-more"]'),spinner:document.querySelector(".spinner")};class S{constructor(t,s){this.buttonEL=t,this.hiddenClass=s}hide(){this.buttonEL.classList.add(this.hiddenClass)}show(){this.buttonEL.classList.remove(this.hiddenClass)}disable(){this.buttonEL.disabled=!0}enable(){this.buttonEL.disabled=!1}}const w=document.querySelector(".list"),c=document.querySelector(".loader"),l=document.querySelector(".js-form");c.style.display="none";l.addEventListener("submit",q);function q(o){o.preventDefault(),w.innerHTML="";const t=o.target.request.value.trim().toLowerCase();t&&(a(c,!0),L(t).then(s=>{if(s.hits.length===0)throw new Error(response.status);a(c,!1),g(s.hits)}).catch(s=>{a(c,!1),E()}).finally(l.reset()))}function E(o){return p.show({message:"Sorry, there are no images matching your search query. Please try again!",color:"red",position:"topRight",closeOnClick:!0})}function a(o,t){t?o.style.display="block":o.style.display="none"}const u=new S(b.loadMoreBtn,"is-hidden");console.log(u);u.hide();
